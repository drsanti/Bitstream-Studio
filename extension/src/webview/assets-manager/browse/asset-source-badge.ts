...
export function assetSourceBadgeClasses(source: AssetSource): string {
  switch (source) {
    case "bundled":
...
/** @deprecated Use {@link assetSourceBadgeClasses}. */
export const studioAssetSourceBadgeClasses = assetSourceBadgeClasses;
