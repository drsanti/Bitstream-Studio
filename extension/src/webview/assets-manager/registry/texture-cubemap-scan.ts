 ...
 */
export function scanFlatTextureDescriptors(): AssetDescriptor[] {
 ...
 */
export function scanCubemapEnvironmentDescriptors(): AssetDescriptor[] {
  if (!REPO_ASSET_STATIC_SCAN_ENABLED) {
    return [];
  }
  const posxModules = {
  ...
  for (const filePath of Object.keys(posxModules)) {
    ...
    out.push({
      ...
      summary: `Environment · ${setFolderName}`,
...
/** @deprecated Use {@link scanFlatTextureDescriptors}. */
export const scanStudioFlatTextureDescriptors = scanFlatTextureDescriptors;
/** @deprecated Use {@link scanCubemapEnvironmentDescriptors}. */
export const scanStudioCubemapEnvironmentDescriptors = scanCubemapEnvironmentDescriptors;
