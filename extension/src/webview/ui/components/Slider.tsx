...
export interface SliderProps
  ...
  label?: string;
  className?: string;
  /** Value label shown next to slider (e.g. "50 Hz") */
  valueLabel?: string;
}
  ...
  return (
    <div className={clsx("flex flex-col gap-0.5 min-w-0", className)}>
      ...
      <input
        ...
        type="range"
        className={clsx(
          "w-full h-1.5 rounded-full appearance-none cursor-pointer bg-zinc-800/85 accent-cyan-500 transition-colors",
          ...
          "[&::-webkit-slider-thumb]:appearance-none [&::-webkit-slider-thumb]:mt-[-4px] [&::-webkit-slider-thumb]:h-3.5 [&::-webkit-slider-thumb]:w-3.5",
