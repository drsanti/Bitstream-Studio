    ...
    nodes: [
      ...
      },
      {
        ...
        outputPorts: [
          ...
          { id: "centroidHz", portType: "number", label: "Cent (Hz)" },
      ...
      },
      {
        ...
        title: "Audio SFX",
        description:
          "One-shot synthesized sound effects (riser, downer, siren, beep, noise burst). Fire from the card, Trigger pin, or graph events.",
        icon: "sparkles",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
      ...
      },
      {
        ...
        title: "Audio Machine",
        description:
          "Continuous procedural mechanical sounds (motor, engine, drone, machine). Drive with Speed and Load scalars from telemetry.",
        icon: "cpu",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
      ...
      },
      {
        ...
        description:
          "Apply a wired live Video Texture to a named GLB material map (base color, emissive, etc.). Spawn from Library **Model → Materials** or bind a material extract manually.",
        icon: "image",
        defaultVisible: true,
        defaultConfig: {
        ...
        inputPorts: [
          { id: "tex", portType: "videoTexture", label: "Texture" },
          { id: "gain", portType: "number", label: "Gain" },
        ],
        outputPorts: [{ id: "active", portType: "boolean", label: "Active" }],
      },
      {
        id: "css3d-camera-feed",
        category: "scene",
        title: "CSS3D Camera Feed",
        description:
          "Place the wired camera stream as a screen or world-space CSS3D panel over Model Viewer / 3D previews.",
        icon: "videocam",
        defaultVisible: true,
        defaultConfig: {
          visible: true,
          opacity: 1,
          anchorMode: "screen",
          anchor: { x: 0.85, y: 0.15, z: 0 },
          sizePx: { w: 320, h: 180 },
          borderRadiusPx: 8,
        },
        inputPorts: [
          { id: "in", portType: "videoBus", label: "In" },
          { id: "visible", portType: "boolean", label: "Visible" },
          { id: "opacity", portType: "number", label: "Opacity" },
        ],
        outputPorts: [{ id: "visible", portType: "boolean", label: "Visible" }],
      },
      {
        id: "camera-view",
        category: "scene",
      ...
      },
      {
        ...
        title: "Vision Pose",
        description:
          "Browser-side pose inference (MediaPipe Pose Landmarker) from a wired Video bus. Outputs normalized landmark vectors plus optional **Trigger** events on detection enter/exit.",
        icon: "scan-line",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
        ...
        outputPorts: [
          { id: "detected", portType: "boolean", label: "Detected" },
          { id: "score", portType: "number", label: "Score" },
          { id: "nose", portType: "vector3", label: "Nose" },
          { id: "leftWrist", portType: "vector3", label: "Left wrist" },
          { id: "rightWrist", portType: "vector3", label: "Right wrist" },
          { id: "trigger", portType: "event", label: "Trigger" },
        ],
      },
      {
        id: "vision-hands",
        ...
        title: "Vision Hands",
        description:
          "MediaPipe Hand Landmarker from a wired Video bus. Outputs index fingertip vectors plus optional **Trigger** on detection enter/exit.",
        icon: "hand",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
        ...
        outputPorts: [
          { id: "detected", portType: "boolean", label: "Detected" },
          { id: "score", portType: "number", label: "Score" },
          { id: "leftIndex", portType: "vector3", label: "Left index" },
          { id: "rightIndex", portType: "vector3", label: "Right index" },
          { id: "trigger", portType: "event", label: "Trigger" },
        ],
      },
      {
        ...
        title: "Vision Face",
        description:
          "MediaPipe Face Landmarker from a wired Video bus. Outputs nose / eye vectors plus optional **Trigger** events.",
        icon: "eye",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
        ...
        outputPorts: [
          ...
          { id: "score", portType: "number", label: "Score" },
          { id: "nose", portType: "vector3", label: "Nose" },
          { id: "leftEye", portType: "vector3", label: "Left eye" },
          { id: "rightEye", portType: "vector3", label: "Right eye" },
          { id: "trigger", portType: "event", label: "Trigger" },
        ],
      },
      {
        ...
        title: "Vision Object",
        description:
          "MediaPipe object detector (EfficientDet Lite0) from a wired Video bus. Outputs top label, score, count, and optional **Trigger**.",
        icon: "package",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
        ...
        outputPorts: [
          { id: "detected", portType: "boolean", label: "Detected" },
          { id: "count", portType: "number", label: "Count" },
          { id: "label", portType: "string", label: "Label" },
          { id: "score", portType: "number", label: "Score" },
          { id: "trigger", portType: "event", label: "Trigger" },
        ],
      },
      {
        id: "vision-landmarks-debug",
        category: "logic",
        title: "Vision Landmarks Debug",
        description:
          "Compact pose landmark export for logging or inspection. Emits landmark **count** and truncated JSON (x/y/visibility) from a wired Video bus.",
        icon: "hash",
        defaultVisible: true,
        defaultConfig: {
          enabled: true,
        ...
        outputPorts: [
          { id: "count", portType: "number", label: "Count" },
          { id: "json", portType: "string", label: "JSON" },
        ],
      },
      {
        id: "threshold",
      ...
      },
      {
        ...
        description:
          "Dropdown on the **Dashboard** pane. Pick a mode or preset; wire **Out** (string) into downstream nodes.",
        icon: "list",
        defaultVisible: true,
        defaultConfig: {
          label: "Mode",
        ...
        outputPorts: [
          { id: "widget", portType: "dashboardWidget", label: "Widget" },
          { id: "out", portType: "string", label: "Out" },
        ],
      },
      {
        id: "dashboard-formatted-text",
        category: "dashboard",
        title: "Dashboard Formatted Text",
        description:
          "Template readout on the **Dashboard** pane. Use `{{value}}` and `{{unit}}` placeholders; wire a number into **Value**.",
        icon: "text",
        defaultVisible: true,
        defaultConfig: {
          label: "Reading",
      ...
      },
      {
        ...
        description:
          "Image tile on the **Dashboard** pane. Wire a string **URL** or set a static image URL on the node.",
        icon: "image",
        defaultVisible: true,
        defaultConfig: {
          label: "Image",
        ...
        inputPorts: [{ id: "in", portType: "string", label: "URL" }],
        outputPorts: [{ id: "widget", portType: "dashboardWidget", label: "Widget" }],
      },
      {
        id: "dashboard-slider",
      ...
      },
      {
        ...
        description:
          "Spawn dynamic rigid bodies into the Rapier preview at a rate (wire into Physics World graph).",
        icon: "sparkles",
        defaultVisible: false,
        defaultConfig: {
          rate: 1,
        ...
        outputPorts: [{ id: "out", portType: "physicsSpawner", label: "Spawner" }],
      },
      {
        id: "fixed-joint",
        category: "utility",
        title: "Fixed Joint",
        description: "Lock two rigid bodies together in the Rapier preview.",
        icon: "link",
        defaultVisible: true,
        defaultConfig: {},
        inputPorts: [
          { id: "bodyA", portType: "physicsBody", label: "Body A" },
          { id: "bodyB", portType: "physicsBody", label: "Body B" },
        ],
        outputPorts: [{ id: "out", portType: "physicsJoint", label: "Joint" }],
      },
      {
        id: "hinge-joint",
        category: "utility",
        title: "Hinge Joint",
        description: "Hinge constraint between two rigid bodies in the Rapier preview.",
        icon: "rotate-cw",
        defaultVisible: false,
      ...
      },
      {
        ...
        title: "Number",
        description:
          "Fixed number on the **`out`** wire. Edit on the **node card** scrub field or in the **inspector Node** tab (same value plus min / max / step).",
        icon: "hash",
        defaultVisible: true,
        defaultConfig: {
          value: 1,
