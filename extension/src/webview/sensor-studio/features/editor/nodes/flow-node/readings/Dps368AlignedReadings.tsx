...
/** DPS368 live panel for the Node Inspector Live tab. */
export function Dps368AlignedReadings(props: Dps368AlignedReadingsProps) {
  const { pressure, temp } = props;

  return (
    <div className="min-w-0 w-full">
      <ScalarReadingRow label="Pressure (hPa)" value={pressure} fractionDigits={2} />
