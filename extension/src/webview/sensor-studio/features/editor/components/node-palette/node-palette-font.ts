/** Inter everywhere in the Sensor Studio node library (matches flow socket labels). */
export const NODE_PALETTE_FONT_CLASS =
...
export const PALETTE_ROW_LABEL_TYPOGRAPHY =
  "font-medium text-zinc-500 text-[11px] leading-tight";
