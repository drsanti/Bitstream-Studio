 ...
 */
export function AssetBrowserEnvironmentPreview(props: AssetBrowserEnvironmentPreviewProps) {
    ...
    return (
      <div className="space-y-1">
        ...
        <div className="rounded border border-zinc-800/80 bg-zinc-950/60 px-1.5 py-1 text-[9px] leading-snug text-zinc-500">
          No raster preview for this URL (e.g. HDR or non-image). Use <span className="text-zinc-400">Copy URL</span>{" "}
          to verify in the scene.
        </div>
      </div>
    );
  }
