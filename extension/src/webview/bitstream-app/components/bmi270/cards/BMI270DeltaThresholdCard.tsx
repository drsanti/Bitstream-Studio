...
import { BMI270_DELTA_THRESHOLD_PRESETS_X100 } from "../../../constants/sensorCfgPresets.js";
import type { Bmi270AckState } from "../types";

const presets = [...BMI270_DELTA_THRESHOLD_PRESETS_X100];

export function BMI270DeltaThresholdCard(props: {
  collapsed: boolean;
  disabled: boolean;
  ack: Bmi270AckState;
  deltaX100: number;
...
{
  const { collapsed, disabled, ack, deltaX100, onToggleCollapsed, onDeltaX100Change, cardApply } = props;
