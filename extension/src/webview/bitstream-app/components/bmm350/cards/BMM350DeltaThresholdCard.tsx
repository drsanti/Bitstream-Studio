...
import { BMM350_DELTA_THRESHOLD_PRESETS_X100 } from "../../../constants/sensorCfgPresets.js";

const presets = [...BMM350_DELTA_THRESHOLD_PRESETS_X100];

export function BMM350DeltaThresholdCard(props: {
  collapsed: boolean;
  disabled: boolean;
  ack: Bmm350AckState;
  deltaX100: number;
  ...
  const { collapsed, disabled, ack, deltaX100, onToggleCollapsed, onDeltaX100Change, cardApply } =
    props;
