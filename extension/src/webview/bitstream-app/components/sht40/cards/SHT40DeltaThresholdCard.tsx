...
import { SHT40_DELTA_THRESHOLD_PRESETS_X100 } from "../../../constants/sensorCfgPresets.js";
import type { Sht40AckState } from "../types";

const presets = [...SHT40_DELTA_THRESHOLD_PRESETS_X100];

export function SHT40DeltaThresholdCard(props: {
  collapsed: boolean;
  disabled: boolean;
  ack: Sht40AckState;
  deltaX100: number;
