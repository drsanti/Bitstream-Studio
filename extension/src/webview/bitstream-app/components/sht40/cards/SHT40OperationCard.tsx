...
import { TRNButton, TRNDragHandle, TRNInteractiveCard, TRNToggleSwitch } from "@/ui/TRN";
import {
...
import type { SensorPublishMode, Sht40AckState } from "../types";
import { SENSOR_CFG_UI } from "../../../constants/sensorConfigUiLabels";

export function SHT40OperationCard(props: {
  collapsed: boolean;
  enabled: boolean;
    ...
    >
      <div className="mb-2 flex items-center justify-between rounded border border-zinc-700/80 bg-transparent px-2 py-1 text-sm">
        ...
        <TRNToggleSwitch
          ...
          ariaLabel="Toggle SHT40 sensor enabled"
        />
      </div>
      <div
      ...
      >
        ...
        <div
          role="radiogroup"
          aria-label="SHT40 telemetry mode"
