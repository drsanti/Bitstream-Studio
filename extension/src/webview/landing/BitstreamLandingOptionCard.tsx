/*******************************************************************************
 * File Name : BitstreamLandingOptionCard.tsx
 *
 * Description : Workspace picker card for the Bitstream Studio landing page.
 *
...
export function BitstreamLandingOptionCard({
  ...
  index,
  onSelect,
}: BitstreamLandingOptionCardProps)
{
    ...
    >
      ...
      <span className="relative z-10 flex flex-1 flex-col gap-4">
        ...
        <span>
          ...
          <span className="mt-0.5 block text-sm font-medium text-zinc-400">
            {option.subtitle}
          </span>
        </span>
