...
export function CourseWidgetBoardEmptySlot({
  ...
  return (
    <div
      className="course-widget-board-grid__empty-slot pointer-events-none z-[1] flex min-h-0 min-w-0 place-self-stretch items-center justify-center"
      style={{
